...
<table border="1" class="dataframe">
  <thead>
    <tr style="text-align: right;">
      ...
      <th>skills that match wholesale merchant in machine tools</th>
      <th>percentage match with wholesale merchant in machine tools</th>
      <th>skills not in wholesale merchant in machine tools</th>
    </tr>
  </thead>
  <tbody>
    <tr>

...
<table border="1" class="dataframe">
  <thead>
    <tr style="text-align: right;">
      ...
      <th>skills that match tunnel boring machine operator</th>
      <th>percentage match with tunnel boring machine operator</th>
      <th>skills not in tunnel boring machine operator</th>
    </tr>
  </thead>
  <tbody>
    <tr>

...
<table border="1" class="dataframe">
  <thead>
    <tr style="text-align: right;">
      ...
      <th>skills that match motor vehicle body assembler</th>
      <th>percentage match with motor vehicle body assembler</th>
      <th>skills not in motor vehicle body assembler</th>
    </tr>
  </thead>
  <tbody>
    <tr>

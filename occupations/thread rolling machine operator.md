...
<table border="1" class="dataframe">
  <thead>
    <tr style="text-align: right;">
      ...
      <th>skills that match thread rolling machine operator</th>
      <th>percentage match with thread rolling machine operator</th>
      <th>skills not in thread rolling machine operator</th>
    </tr>
  </thead>
  <tbody>
    <tr>

...
<table border="1" class="dataframe">
  <thead>
    <tr style="text-align: right;">
      ...
      <th>skills that match oxy fuel burning machine operator</th>
      <th>percentage match with oxy fuel burning machine operator</th>
      <th>skills not in oxy fuel burning machine operator</th>
    </tr>
  </thead>
  <tbody>
    <tr>

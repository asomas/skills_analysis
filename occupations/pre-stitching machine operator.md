...
<table border="1" class="dataframe">
  <thead>
    <tr style="text-align: right;">
      ...
      <th>skills that match pre-stitching machine operator</th>
      <th>percentage match with pre-stitching machine operator</th>
      <th>skills not in pre-stitching machine operator</th>
    </tr>
  </thead>
  <tbody>
    <tr>
